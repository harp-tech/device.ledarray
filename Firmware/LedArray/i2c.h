...
//*****************************************************************************
	...
	#define toggle_SDA2 toogle_io(I2C2_PORT, I2C2_SDA)
	#define set_SCL2 set_io(I2C2_PORT, I2C2_SCL)
	#define clear_SCL2 clear_io(I2C2_PORT, I2C2_SCL)
	#define toggle_SCL2 toogle_io(I2C2_PORT, I2C2_SCL)
	...
	#define toggle_SDA3 toogle_io(I2C3_PORT, I2C3_SDA)
	#define set_SCL3 set_io(I2C3_PORT, I2C3_SCL)
	#define clear_SCL3 clear_io(I2C3_PORT, I2C3_SCL)
	#define toggle_SCL3 toogle_io(I2C3_PORT, I2C3_SCL)
...
//*****************************************************************************
	...
	bool i2c0_wArray(i2c_dev_t* dev, uint8_t bytes2write);
